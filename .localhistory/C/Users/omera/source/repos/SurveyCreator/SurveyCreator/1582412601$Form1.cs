...
namespace SurveyCreator
{
    public partial class Form1 : Form
    {
        ...
        private void btnAnketiOlustur_Click(object sender, EventArgs e)
        {
            ...
            enSayfaYonu sayfaYonu = enSayfaYonu.Dikey;
            var sayfaYonuRDB = gbSayfaYonu.Controls.OfType<RadioButton>().FirstOrDefault(r => r.Checked);
            if (sayfaYonuRDB.Text == "Yatay")
                sayfaYonu = enSayfaYonu.Yatay;
            ...
            if (save.ShowDialog() == DialogResult.OK)
                ANKET.filePathAndName = save.FileName.ToString();

            PDFOLUSTUR PDF = new PDFOLUSTUR(ANKET);
        }
    }
}
