...
namespace SurveyCreator
{
    public partial class Form1 : Form
    {
        ...
        private void btnAnketiOlustur_Click(object sender, EventArgs e)
        {
            ...
            var checkedButton = gbSayfaSayisi.Controls.OfType<RadioButton>().FirstOrDefault(r => r.Checked);
            var checkedButton = gbSayfaYonu.Controls.OfType<RadioButton>().FirstOrDefault(r => r.Checked);
        }
    }
}
